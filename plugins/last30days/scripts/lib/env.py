...
def _find_project_env() -> Optional[Path]:
    ...
    Searches for .codex/last30days.env first, then .claude/last30days.env,
...
def get_config() -> Dict[str, Any]:
    ...
    Priority (highest wins):
      ...
      2. .codex/last30days.env (preferred per-project config)
      3. .claude/last30days.env (compatible per-project config)
      4. ~/.config/last30days/.env (global config)
    """
