...
To fix this:
1. Add AUTH_TOKEN and CT0 to .codex/last30days.env, ~/.config/last30days/.env, or .claude/last30days.env
...
def show_diagnostic_banner(diag: dict):
    ...
    if IS_TTY:
        ...
        if has_openai:
            ...
            lines.append(f"{Colors.DIM}│{Colors.RESET}     └─ Add to .codex/last30days.env                {Colors.DIM}│{Colors.RESET}")
        ...
        lines.append(f"{Colors.DIM}│{Colors.RESET}                                                     {Colors.DIM}│{Colors.RESET}")
        lines.append(f"{Colors.DIM}│{Colors.RESET}  Config: {Colors.BOLD}.codex/last30days.env{Colors.RESET}                  {Colors.DIM}│{Colors.RESET}")
        lines.append(f"{Colors.DIM}└─────────────────────────────────────────────────────┘{Colors.RESET}")
    else:
        ...
        if has_openai:
            ...
            lines.append("│     └─ Add to .codex/last30days.env                │")
        ...
        lines.append("│                                                     │")
        lines.append("│  Config: .codex/last30days.env                      │")
        lines.append("└─────────────────────────────────────────────────────┘")
